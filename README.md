...
我想很多程序员应该记得 GitHub 上有一个 Awesome - XXX 系列的资源整理。[awesome-ios](https://github.com/vsouza/awesome-ios) ⭐ 53,455 | 🐛 27 | 🌐 Swift | 📅 2026-08-27 就是 vsouza 发起维护的 iOS 资源列表，内容包括：框架、组件、测试、Apple Store、SDK、XCode、网站、书籍等。Swift 语言写成的项目会被标记为 ★ ，AppleWatch 的项目则会被标记为 ▲。
...
* [AudioKit](http://hao.importnew.com/audiokit/)：一个强大的音频合成，处理和分析的工具集。[官网](https://github.com/audiokit/AudioKit) ⭐ 11,464 | 🐛 7 | 🌐 Swift | 📅 2026-07-26
...
* [ios-charts](http://hao.importnew.com/ios-charts/)：一个强大的图表框架，[MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,171 | 🐛 2,066 | 🌐 Java | 📅 2026-09-22 在 iOS 上的移植。★[官网](https://github.com/danielgindi/ios-charts) ⭐ 28,005 | 🐛 977 | 🌐 Swift | 📅 2026-03-07
...
* SDWebImage：异步的图像下载器，提供了缓存支持。以 UIImageView 类别的方式提供。[官网](https://github.com/rs/SDWebImage) ⭐ 25,630 | 🐛 132 | 🌐 Objective-C | 📅 2026-04-15
* GPU Image：一个基于 GPU 的 iOS 开源的图像和视频处理框架。[官网](https://github.com/BradLarson/GPUImage) ⭐ 20,292 | 🐛 1,000 | 🌐 Objective-C | 📅 2024-02-16
* Nuke：高级的图片管理框架。★[官网](https://github.com/kean/Nuke) ⭐ 8,673 | 🐛 14 | 🌐 Swift | 📅 2026-09-25
...
* Alamofire：Alamofire 是一个 Swift 写的 HTTP 网络库，由 AFNetworking 的作者编写。★[官网](https://github.com/Alamofire/Alamofire) ⭐ 42,420 | 🐛 43 | 🌐 Swift | 📅 2026-09-14
...
* RestKit：RestKit 是一个 iOS Objective-C 框架，是为了让和 RESTful web 服务交互变的简单、快捷、有趣。[官网](https://github.com/RestKit/RestKit) ⭐ 10,085 | 🐛 364 | 🌐 Objective-C | 📅 2022-08-27
...
* ActionSheetPicker-3.0：为 iOS App 快速制作一个下拉 UIPickerView / ActionSheet 功能。[官网](https://github.com/skywinder/ActionSheetPicker-3.0/) ⭐ 3,376 | 🐛 19 | 🌐 Objective-C | 📅 2026-06-12
...
* SwiftLint：一个实验性的工具，用于强化 Swift 的代码风格和习惯。★[官网](https://github.com/realm/SwiftLint) ⭐ 19,746 | 🐛 514 | 🌐 Swift | 📅 2026-09-25
...
* [Darling](http://hao.importnew.com/darling/)：在 Linux 运行 OS X 二进制文件。[官网](http://www.darlinghq.org)、[GitHub](https://github.com/LubosD/darling) ⭐ 13,394 | 🐛 404 | 🌐 Objective-C | 📅 2026-09-06
...
* R.swift：在 Swift 项目中，强类型的自动补全资源名称的工具，包括图片，单元格和 segue 的工具。★[官网](https://github.com/mac-cain13/R.swift) ⭐ 9,558 | 🐛 78 | 🌐 Swift | 📅 2025-04-01
...
* [fastlane](https://github.com/fastlane/fastlane) ⭐ 42,161 | 🐛 665 | 🌐 Ruby | 📅 2026-09-25 将所有 iOS 部署工具整合到一个工作流中。
...
* [Stripe](https://github.com/stripe/stripe-ios) ⭐ 2,569 | 🐛 324 | 🌐 Swift | 📅 2026-09-25：iOS and OS X Stripe 绑定框架。
...
* [Futurice iOS Good Practices](https://github.com/futurice/ios-good-practices) ⭐ 10,975 | 🐛 22 | 📅 2024-04-30：[@futurice](https://github.com/futurice) 介绍的 iOS 入门指南和最佳实践。
...
* [Open Source apps](https://github.com/dkhamsing/open-source-ios-apps) ⭐ 52,287 | 🐛 7 | 📅 2026-09-25 开源 iOS app 列表。
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,688 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02 列表。
...
* 优秀的 Swift 列表
  * [@matteocrippa](https://github.com/matteocrippa/awesome-swift) ⭐ 26,282 | 🐛 15 | 🌐 Ruby | 📅 2026-09-01：一个优秀的 Swift 资源合集列表。
