...
我想很多程序员应该记得 GitHub 上有一个 Awesome - XXX 系列的资源整理。[awesome-ios](https://github.com/vsouza/awesome-ios) ⭐ 53,275 | 🐛 25 | 🌐 Swift | 📅 2026-08-27 就是 vsouza 发起维护的 iOS 资源列表，内容包括：框架、组件、测试、Apple Store、SDK、XCode、网站、书籍等。Swift 语言写成的项目会被标记为 ★ ，AppleWatch 的项目则会被标记为 ▲。
...
* [Canvas](http://hao.importnew.com/canvas/)：无需代码就可以在 Xcode 中显示动画 <http://canvaspod.io>。[官网](https://github.com/CanvasPod/Canvas) ⭐ 5,271 | 🐛 37 | 🌐 Objective-C | 📅 2019-07-14
...
* [ios-charts](http://hao.importnew.com/ios-charts/)：一个强大的图表框架，[MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,185 | 🐛 2,191 | 🌐 Java | 📅 2025-06-05 在 iOS 上的移植。★[官网](https://github.com/danielgindi/ios-charts) ⭐ 28,011 | 🐛 977 | 🌐 Swift | 📅 2026-03-07
...
* [MagicalRecord](http://hao.importnew.com/magicalrecord/)：非常优秀的 CoreData 便捷存取框架。[官网](https://github.com/magicalpanda/MagicalRecord) ⭐ 10,701 | 🐛 242 | 🌐 Objective-C | 📅 2021-04-27
...
* PromiseKit：iOS 和 OS X 上的 Promises 实现。[官网](https://github.com/mxcl/PromiseKit) ⭐ 14,227 | 🐛 15 | 🌐 Swift | 📅 2026-06-03
...
* PureLayout：终极的 iOS 和 OS X 上的 Autolayout API，极其简单又异常强大。同时适用于 Objective-C 和 Swift。[官网](https://github.com/PureLayout/PureLayout) ⭐ 7,593 | 🐛 46 | 🌐 Objective-C | 📅 2023-03-16
...
* CocoaLumberjack：一个快捷强大灵活的日志框架，可用于 iOS & Mac。[官网](https://github.com/CocoaLumberjack/CocoaLumberjack) ⭐ 13,322 | 🐛 6 | 🌐 Objective-C | 📅 2026-08-12
...
* Nuke：高级的图片管理框架。★[官网](https://github.com/kean/Nuke) ⭐ 8,662 | 🐛 13 | 🌐 Swift | 📅 2026-09-05
...
* Alamofire：Alamofire 是一个 Swift 写的 HTTP 网络库，由 AFNetworking 的作者编写。★[官网](https://github.com/Alamofire/Alamofire) ⭐ 42,425 | 🐛 44 | 🌐 Swift | 📅 2026-08-31
...
* RestKit：RestKit 是一个 iOS Objective-C 框架，是为了让和 RESTful web 服务交互变的简单、快捷、有趣。[官网](https://github.com/RestKit/RestKit) ⭐ 10,091 | 🐛 364 | 🌐 Objective-C | 📅 2022-08-27
...
* JazzHands：Jazz Hands 是一个简单的 UIKit 关键帧动画框架。动画是可以使用手势、滚动视图、KVO 或者 ReactiveCocoa 来控制的。[官网](https://github.com/IFTTT/JazzHands) ⭐ 6,358 | 🐛 14 | 🌐 Objective-C | 📅 2024-07-30
* Instructions：向你的 iOS 项目中添加自定义的操作方式指导的简单办法。★[官网](https://github.com/ephread/Instructions) ⭐ 5,202 | 🐛 17 | 🌐 Swift | 📅 2024-06-05
* EAIntroView：高度可定制非侵入式的欢迎页面解决方案。[官网](https://github.com/ealeksandrov/EAIntroView) ⭐ 3,729 | 🐛 20 | 🌐 Objective-C | 📅 2020-11-10
* RazzleDazzle：简单的基于关键帧的 iOS 动画框架，由 Swift 编写。最适合用于 App 的滚动介绍页面。★[官网](https://github.com/IFTTT/RazzleDazzle) ⭐ 3,344 | 🐛 23 | 🌐 Swift | 📅 2023-10-11
...
* iCarousel：iOS 和 Mac OS 上简单的，高度可定制化的数据驱动 3D 跑马灯。[官网](https://github.com/nicklockwood/iCarousel) ⭐ 12,105 | 🐛 401 | 🌐 Objective-C | 📅 2024-06-27
...
* FlatUIKit：适用于 iOS 的扁平化 UI 组件集合。[官网](https://github.com/Grouper/FlatUIKit) ⭐ 7,726 | 🐛 35 | 🌐 Objective-C | 📅 2016-09-29
* JTAppleCalendar: 最好的iOS版雨燕日历库 ★[官网](https://github.com/patchthecode/JTAppleCalendar) ⭐ 7,650 | 🐛 83 | 🌐 Swift | 📅 2024-07-23
* JVFloatLabeledTextField：附有浮动标签的 UITextField 子类。[官网](https://github.com/jverdi/JVFloatLabeledTextField) ⭐ 7,137 | 🐛 28 | 🌐 Objective-C | 📅 2023-04-17
...
* MGSwipeTableCell：可以显示滑动按钮的 UITableViewCell 的子类，还支持多种过渡动画。[官网](https://github.com/MortimerGoro/MGSwipeTableCell) ⭐ 6,913 | 🐛 132 | 🌐 Objective-C | 📅 2023-03-22
...
* LiquidFloatingActionButton：流体状态的 Material Design 的浮动按钮。[官网](https://github.com/yoavlt/LiquidFloatingActionButton) ⭐ 3,841 | 🐛 53 | 🌐 Swift | 📅 2022-07-08
...
* VBFPopFlatButton：基于 Facebook POP制作的，有9种不同状态动画的扁平化按钮。[官网](https://github.com/victorBaro/VBFPopFlatButton) ⭐ 3,063 | 🐛 8 | 🌐 Objective-C | 📅 2024-07-15
* RKNotificationHub：让任何 UIView 变成完善的通知中心。[官网](https://github.com/cwRichardKim/RKNotificationHub) ⭐ 3,030 | 🐛 3 | 🌐 Objective-C | 📅 2018-11-02
...
* MPParallaxView：Swift 实现的 Apple TV 视差效果。★[官网](https://github.com/DroidsOnRoids/MPParallaxView) ⭐ 1,733 | 🐛 2 | 🌐 Swift | 📅 2018-06-14
...
* MotionBlur：MotionBlur 让你可以在 iOS 动画效果上添加模糊效果。[官网](https://github.com/fastred/MotionBlur) ⭐ 1,496 | 🐛 1 | 🌐 Objective-C | 📅 2015-04-04
* CBZSplashView：Twitter 样式的启动页（Splash Screen）视图，缩放后显示主视图。[官网](https://github.com/callumboddy/CBZSplashView) ⭐ 1,477 | 🐛 13 | 🌐 Objective-C | 📅 2017-02-01
...
* CardAnimation：卡片翻页动画效果。★[官网](https://github.com/seedante/CardAnimation) ⭐ 1,163 | 🐛 0 | 🌐 Swift | 📅 2021-01-20
...
* Swift-Prompts：用来设计自定义提示的 Swift 库，有很大的范围可供选择。★[官网](https://github.com/GabrielAlva/Swift-Prompts) ⭐ 725 | 🐛 8 | 🌐 Swift | 📅 2018-04-24
...
* DAExpandAnimation：以自定义的模态过渡效果，从 cell 中展开来呈现控制器的库。★[官网](https://github.com/ifitdoesntwork/DAExpandAnimation) ⭐ 579 | 🐛 3 | 🌐 Swift | 📅 2025-02-01
...
* [Darling](http://hao.importnew.com/darling/)：在 Linux 运行 OS X 二进制文件。[官网](http://www.darlinghq.org)、[GitHub](https://github.com/LubosD/darling) ⭐ 13,320 | 🐛 399 | 🌐 Objective-C | 📅 2026-08-30
...
* Carthage：简单的分布式的 Cocoa 依赖管理器。★[官网](https://github.com/Carthage/Carthage) ⭐ 15,165 | 🐛 217 | 🌐 Swift | 📅 2025-09-10
...
* PonyDebugger：使用 Chrome 开发者工具对你的 iOS app 进行远程网络和数据调试。[官网](https://github.com/square/PonyDebugger) ⭐ 5,851 | 🐛 46 | 🌐 Objective-C | 📅 2023-03-18
...
* boarding：即时为 TestFlight beta 测试者创建简单的注册页面。[官网](https://github.com/fastlane/boarding) ⭐ 880 | 🐛 54 | 🌐 Ruby | 📅 2024-03-18
...
* injectionforxcode：代码注入，支持 Swift。[官网](https://github.com/johnno1962/injectionforxcode) ⭐ 6,538 | 🐛 76 | 🌐 Objective-C | 📅 2022-08-04
...
* [fastlane](https://github.com/fastlane/fastlane) ⭐ 42,064 | 🐛 662 | 🌐 Ruby | 📅 2026-09-04 将所有 iOS 部署工具整合到一个工作流中。
...
* [Facebook](https://github.com/facebook/facebook-ios-sdk) ⭐ 8,096 | 🐛 152 | 🌐 Swift | 📅 2026-08-31：Facebook iOS SDK。
...
* [Stripe](https://github.com/stripe/stripe-ios) ⭐ 2,569 | 🐛 289 | 🌐 Swift | 📅 2026-09-05：iOS and OS X Stripe 绑定框架。
...
* ColorSense-for-Xcode：可视化的颜色选择插件。[官网](https://github.com/omz/ColorSense-for-Xcode) ⭐ 2,778 | 🐛 43 | 🌐 Objective-C | 📅 2016-03-22
...
* [Swift Style Guide by @raywenderlich](https://github.com/raywenderlich/swift-style-guide) ⭐ 13,155 | 🐛 16 | 📅 2025-04-01：raywenderlich.com 官方的 Swift 编码风格规范。★
...
* [Open Source apps](https://github.com/dkhamsing/open-source-ios-apps) ⭐ 51,984 | 🐛 2 | 📅 2026-09-05 开源 iOS app 列表。
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,654 | 🐛 62 | 🌐 Ruby | 📅 2024-06-02 列表。
...
* 优秀的 Swift 列表
  * [@matteocrippa](https://github.com/matteocrippa/awesome-swift) ⭐ 26,241 | 🐛 12 | 🌐 Ruby | 📅 2026-09-01：一个优秀的 Swift 资源合集列表。
