...
我想很多程序员应该记得 GitHub 上有一个 Awesome - XXX 系列的资源整理。[awesome-ios](https://github.com/vsouza/awesome-ios) ⭐ 53,062 | 🐛 19 | 🌐 Swift | 📅 2026-06-24 就是 vsouza 发起维护的 iOS 资源列表，内容包括：框架、组件、测试、Apple Store、SDK、XCode、网站、书籍等。Swift 语言写成的项目会被标记为 ★ ，AppleWatch 的项目则会被标记为 ▲。
...
* [AudioKit](http://hao.importnew.com/audiokit/)：一个强大的音频合成，处理和分析的工具集。[官网](https://github.com/audiokit/AudioKit) ⭐ 11,434 | 🐛 2 | 🌐 Swift | 📅 2026-07-26
...
* [ios-charts](http://hao.importnew.com/ios-charts/)：一个强大的图表框架，[MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,196 | 🐛 2,191 | 🌐 Java | 📅 2025-06-05 在 iOS 上的移植。★[官网](https://github.com/danielgindi/ios-charts) ⭐ 28,014 | 🐛 977 | 🌐 Swift | 📅 2026-03-07
...
* MBProgressHUD：用于显示一个半透明的 HUD。当任务在后台线程结束时可以在上边显示一个指示器和／或者标签。[官网](https://github.com/jdg/MBProgressHUD) ⭐ 15,935 | 🐛 94 | 🌐 Objective-C | 📅 2024-08-14
...
* SwiftyJSON：使用 Swift 处理 JSON 数据的好方法。★[官网](https://github.com/SwiftyJSON/SwiftyJSON) ⭐ 22,950 | 🐛 139 | 🌐 Swift | 📅 2026-03-04
...
* SDWebImage：异步的图像下载器，提供了缓存支持。以 UIImageView 类别的方式提供。[官网](https://github.com/rs/SDWebImage) ⭐ 25,639 | 🐛 129 | 🌐 Objective-C | 📅 2026-04-15
...
* TOCropViewController：一个可以允许用户修改 UIImage 对象的视图控制器。[官网](https://github.com/TimOliver/TOCropViewController) ⭐ 4,945 | 🐛 103 | 🌐 Objective-C | 📅 2026-07-28
...
* PhoneNumberKit：用于解析，格式化和验证国际电话号码的 Swift 框架，由谷歌的 libphonenumber 库支持。★[官网](https://github.com/marmelroy/PhoneNumberKit) ⭐ 5,386 | 🐛 20 | 🌐 Swift | 📅 2026-05-25
...
* IQKeyboardManager：防止键盘滑出来遮挡住 UITextField/UITextView 的框架，非侵入，无需代码。[官网](https://github.com/hackiftekhar/IQKeyboardManager) ⭐ 16,632 | 🐛 8 | 🌐 Swift | 📅 2026-05-25
...
* JDStatusBarNotification：显示在顶部状态栏的通知，使用简单，可以自定义。[官网](https://github.com/jaydee3/JDStatusBarNotification) ⭐ 4,332 | 🐛 5 | 🌐 Swift | 📅 2024-12-18
...
* RKNotificationHub：让任何 UIView 变成完善的通知中心。[官网](https://github.com/cwRichardKim/RKNotificationHub) ⭐ 3,037 | 🐛 3 | 🌐 Objective-C | 📅 2018-11-02
...
* SVWebViewController：一个非侵入式的内置浏览器。[官网](https://github.com/TransitApp/SVWebViewController) ⭐ 2,556 | 🐛 74 | 🌐 Objective-C | 📅 2020-04-30
...
* [Darling](http://hao.importnew.com/darling/)：在 Linux 运行 OS X 二进制文件。[官网](http://www.darlinghq.org)、[GitHub](https://github.com/LubosD/darling) ⭐ 12,974 | 🐛 395 | 🌐 Objective-C | 📅 2026-08-09
...
* Quick：Swift 和 Objective-C 的 BDD 框架。[官网](https://github.com/Quick/Quick) ⭐ 9,830 | 🐛 48 | 🌐 Swift | 📅 2026-05-18
...
* DoraemonKit: 一款功能齐全的iOS研发助手，你值得拥有。[官网](https://www.dokit.cn/) [Github](https://github.com/didi/DoraemonKit) ⭐ 20,409 | 🐛 275 | 🌐 Java | 📅 2025-08-12
...
* Localize-Swift：Swift 2.0 实现在应用中切换语言的功能，帮助你的 APP 实现友好的本地化和国际化。★[官网](https://github.com/marmelroy/Localize-Swift) ⭐ 3,125 | 🐛 76 | 🌐 Swift | 📅 2023-09-06
...
* [fastlane](https://github.com/fastlane/fastlane) ⭐ 41,992 | 🐛 673 | 🌐 Ruby | 📅 2026-08-14 将所有 iOS 部署工具整合到一个工作流中。
...
* [Stripe](https://github.com/stripe/stripe-ios) ⭐ 2,563 | 🐛 285 | 🌐 Swift | 📅 2026-08-14：iOS and OS X Stripe 绑定框架。
...
* [Box](https://github.com/box/box-ios-sdk) ⭐ 129 | 🐛 7 | 🌐 Swift | 📅 2026-08-14：Box iOS 和 OS X SDK API。
...
* [Open Source apps](https://github.com/dkhamsing/open-source-ios-apps) ⭐ 51,666 | 🐛 2 | 📅 2026-08-14 开源 iOS app 列表。
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,608 | 🐛 60 | 🌐 Ruby | 📅 2024-06-02 列表。
* [awesome-ios-ui](https://github.com/cjwirth/awesome-ios-ui) ⭐ 11,214 | 🐛 12 | 📅 2018-03-08：优秀的 iOS UI/UX 库列表。
* [awesome-ios-animation](https://github.com/sxyx2008/awesome-ios-animation) ⭐ 5,453 | 🐛 0 | 📅 2025-10-28：包括了 Objective-C 和 Swift 实现的 iOS 动画库列表。
...
* 优秀的 Swift 列表
  * [@matteocrippa](https://github.com/matteocrippa/awesome-swift) ⭐ 26,203 | 🐛 8 | 🌐 Ruby | 📅 2026-08-03：一个优秀的 Swift 资源合集列表。
  * [@Wolg](https://github.com/Wolg/awesome-swift) ⭐ 5,876 | 🐛 111 | 📅 2026-04-12：一个很棒的 Swift 框架，库和软件的策划列表。
