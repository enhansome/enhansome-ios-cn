...
我想很多程序员应该记得 GitHub 上有一个 Awesome - XXX 系列的资源整理。[awesome-ios](https://github.com/vsouza/awesome-ios) ⭐ 53,392 | 🐛 27 | 🌐 Swift | 📅 2026-08-27 就是 vsouza 发起维护的 iOS 资源列表，内容包括：框架、组件、测试、Apple Store、SDK、XCode、网站、书籍等。Swift 语言写成的项目会被标记为 ★ ，AppleWatch 的项目则会被标记为 ▲。
...
* [ios-charts](http://hao.importnew.com/ios-charts/)：一个强大的图表框架，[MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,171 | 🐛 2,191 | 🌐 Java | 📅 2025-06-05 在 iOS 上的移植。★[官网](https://github.com/danielgindi/ios-charts) ⭐ 28,008 | 🐛 977 | 🌐 Swift | 📅 2026-03-07
...
* Realm：CoreData 和 SQLite 的替代品。简洁、现代、快速。[官网](https://github.com/realm/realm-cocoa) ⭐ 16,609 | 🐛 499 | 🌐 Objective-C | 📅 2026-09-18
...
* Nuke：高级的图片管理框架。★[官网](https://github.com/kean/Nuke) ⭐ 8,667 | 🐛 24 | 🌐 Swift | 📅 2026-09-17
...
* PINRemoteImage：一个线程安全、高性能、特性丰富的图像获取器。[官网](https://github.com/pinterest/PINRemoteImage) ⭐ 4,023 | 🐛 62 | 🌐 Objective-C | 📅 2026-09-18
...
* JazzHands：Jazz Hands 是一个简单的 UIKit 关键帧动画框架。动画是可以使用手势、滚动视图、KVO 或者 ReactiveCocoa 来控制的。[官网](https://github.com/IFTTT/JazzHands) ⭐ 6,353 | 🐛 14 | 🌐 Objective-C | 📅 2024-07-30
...
* [Darling](http://hao.importnew.com/darling/)：在 Linux 运行 OS X 二进制文件。[官网](http://www.darlinghq.org)、[GitHub](https://github.com/LubosD/darling) ⭐ 13,362 | 🐛 404 | 🌐 Objective-C | 📅 2026-09-06
...
* Kif：一个 iOS 的函数式测试框架。[官网](https://github.com/kif-framework/KIF) ⭐ 6,244 | 🐛 56 | 🌐 Objective-C | 📅 2026-08-13
...
* [fastlane](https://github.com/fastlane/fastlane) ⭐ 42,129 | 🐛 671 | 🌐 Ruby | 📅 2026-09-18 将所有 iOS 部署工具整合到一个工作流中。
...
* [Stripe](https://github.com/stripe/stripe-ios) ⭐ 2,569 | 🐛 311 | 🌐 Swift | 📅 2026-09-18：iOS and OS X Stripe 绑定框架。
...
* [Open Source apps](https://github.com/dkhamsing/open-source-ios-apps) ⭐ 52,174 | 🐛 2 | 📅 2026-09-18 开源 iOS app 列表。
...
* 优秀的 Swift 列表
  * [@matteocrippa](https://github.com/matteocrippa/awesome-swift) ⭐ 26,262 | 🐛 14 | 🌐 Ruby | 📅 2026-09-01：一个优秀的 Swift 资源合集列表。
