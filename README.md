...
我想很多程序员应该记得 GitHub 上有一个 Awesome - XXX 系列的资源整理。[awesome-ios](https://github.com/vsouza/awesome-ios) ⭐ 53,320 | 🐛 27 | 🌐 Swift | 📅 2026-08-27 就是 vsouza 发起维护的 iOS 资源列表，内容包括：框架、组件、测试、Apple Store、SDK、XCode、网站、书籍等。Swift 语言写成的项目会被标记为 ★ ，AppleWatch 的项目则会被标记为 ▲。
...
* [AudioKit](http://hao.importnew.com/audiokit/)：一个强大的音频合成，处理和分析的工具集。[官网](https://github.com/audiokit/AudioKit) ⭐ 11,458 | 🐛 6 | 🌐 Swift | 📅 2026-07-26
...
* [JSPatch](http://hao.importnew.com/jspatch/)：JSPatch 利用 Objective-C 运行时桥接了 Objective-C 和 Javascript。你仅需引入一个小的引擎，就可以使用 JS 调用任何 Objective-C 的类。JSPatch 通常用来对 iOS App 做热修复（hotfix）。[官网](https://github.com/bang590/JSPatch) ⭐ 11,325 | 🐛 106 | 🌐 Objective-C | 📅 2020-12-01
...
* [ios-charts](http://hao.importnew.com/ios-charts/)：一个强大的图表框架，[MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,181 | 🐛 2,191 | 🌐 Java | 📅 2025-06-05 在 iOS 上的移植。★[官网](https://github.com/danielgindi/ios-charts) ⭐ 28,008 | 🐛 977 | 🌐 Swift | 📅 2026-03-07
...
* MBProgressHUD：用于显示一个半透明的 HUD。当任务在后台线程结束时可以在上边显示一个指示器和／或者标签。[官网](https://github.com/jdg/MBProgressHUD) ⭐ 15,922 | 🐛 94 | 🌐 Objective-C | 📅 2024-08-14
...
* CocoaLumberjack：一个快捷强大灵活的日志框架，可用于 iOS & Mac。[官网](https://github.com/CocoaLumberjack/CocoaLumberjack) ⭐ 13,318 | 🐛 7 | 🌐 Objective-C | 📅 2026-08-12
...
* Nuke：高级的图片管理框架。★[官网](https://github.com/kean/Nuke) ⭐ 8,663 | 🐛 19 | 🌐 Swift | 📅 2026-09-11
...
* Alamofire：Alamofire 是一个 Swift 写的 HTTP 网络库，由 AFNetworking 的作者编写。★[官网](https://github.com/Alamofire/Alamofire) ⭐ 42,421 | 🐛 42 | 🌐 Swift | 📅 2026-09-10
...
* YYText：iOS 上用于显示和编辑富文本的强大文本框架。[官网](https://github.com/ibireme/YYText) ⭐ 8,868 | 🐛 516 | 🌐 Objective-C | 📅 2024-07-16
...
* SwiftLint：一个实验性的工具，用于强化 Swift 的代码风格和习惯。★[官网](https://github.com/realm/SwiftLint) ⭐ 19,725 | 🐛 499 | 🌐 Swift | 📅 2026-09-03
...
* [Darling](http://hao.importnew.com/darling/)：在 Linux 运行 OS X 二进制文件。[官网](http://www.darlinghq.org)、[GitHub](https://github.com/LubosD/darling) ⭐ 13,344 | 🐛 398 | 🌐 Objective-C | 📅 2026-09-06
...
* [fastlane](https://github.com/fastlane/fastlane) ⭐ 42,104 | 🐛 675 | 🌐 Ruby | 📅 2026-09-11 将所有 iOS 部署工具整合到一个工作流中。
...
* [Facebook](https://github.com/facebook/facebook-ios-sdk) ⭐ 8,104 | 🐛 152 | 🌐 Swift | 📅 2026-09-11：Facebook iOS SDK。
...
* [Stripe](https://github.com/stripe/stripe-ios) ⭐ 2,571 | 🐛 294 | 🌐 Swift | 📅 2026-09-11：iOS and OS X Stripe 绑定框架。
...
* [Open Source apps](https://github.com/dkhamsing/open-source-ios-apps) ⭐ 52,081 | 🐛 2 | 📅 2026-09-11 开源 iOS app 列表。
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,664 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02 列表。
...
* 优秀的 Swift 列表
  * [@matteocrippa](https://github.com/matteocrippa/awesome-swift) ⭐ 26,248 | 🐛 13 | 🌐 Ruby | 📅 2026-09-01：一个优秀的 Swift 资源合集列表。
  * [@Wolg](https://github.com/Wolg/awesome-swift) ⭐ 5,888 | 🐛 111 | 📅 2026-04-12：一个很棒的 Swift 框架，库和软件的策划列表。
