...
我想很多程序员应该记得 GitHub 上有一个 Awesome - XXX 系列的资源整理。[awesome-ios](https://github.com/vsouza/awesome-ios) ⭐ 53,164 | 🐛 24 | 🌐 Swift | 📅 2026-06-24 就是 vsouza 发起维护的 iOS 资源列表，内容包括：框架、组件、测试、Apple Store、SDK、XCode、网站、书籍等。Swift 语言写成的项目会被标记为 ★ ，AppleWatch 的项目则会被标记为 ▲。
...
* [AudioKit](http://hao.importnew.com/audiokit/)：一个强大的音频合成，处理和分析的工具集。[官网](https://github.com/audiokit/AudioKit) ⭐ 11,441 | 🐛 6 | 🌐 Swift | 📅 2026-07-26
...
* [Spring](http://hao.importnew.com/spring_ios/)：一个简单的 Swift iOS 动画库。[官网](https://github.com/MengTo/Spring) ⭐ 14,049 | 🐛 164 | 🌐 Swift | 📅 2023-07-03
...
* MBProgressHUD：用于显示一个半透明的 HUD。当任务在后台线程结束时可以在上边显示一个指示器和／或者标签。[官网](https://github.com/jdg/MBProgressHUD) ⭐ 15,932 | 🐛 94 | 🌐 Objective-C | 📅 2024-08-14
...
* Nuke：高级的图片管理框架。★[官网](https://github.com/kean/Nuke) ⭐ 8,655 | 🐛 14 | 🌐 Swift | 📅 2026-08-24
...
* CocoaAsyncSocket：用于 Mac 和 iOS 的异步 socket 网络库。[官网](https://github.com/robbiehanson/CocoaAsyncSocket) ⭐ 12,450 | 🐛 1 | 🌐 Objective-C | 📅 2026-06-23
...
* SwiftLint：一个实验性的工具，用于强化 Swift 的代码风格和习惯。★[官网](https://github.com/realm/SwiftLint) ⭐ 19,708 | 🐛 497 | 🌐 Swift | 📅 2026-08-25
...
* Segment：将分析继承进 iOS 应用中的简单方式。[官网](https://github.com/segmentio/analytics-ios) ⭐ 418 | 🐛 43 | 🌐 Objective-C | 📅 2025-03-27
...
* [Darling](http://hao.importnew.com/darling/)：在 Linux 运行 OS X 二进制文件。[官网](http://www.darlinghq.org)、[GitHub](https://github.com/LubosD/darling) ⭐ 13,104 | 🐛 398 | 🌐 Objective-C | 📅 2026-08-22
...
* [fastlane](https://github.com/fastlane/fastlane) ⭐ 42,028 | 🐛 675 | 🌐 Ruby | 📅 2026-08-25 将所有 iOS 部署工具整合到一个工作流中。
...
* [Stripe](https://github.com/stripe/stripe-ios) ⭐ 2,564 | 🐛 278 | 🌐 Swift | 📅 2026-08-25：iOS and OS X Stripe 绑定框架。
...
* [Box](https://github.com/box/box-ios-sdk) ⭐ 129 | 🐛 13 | 🌐 Swift | 📅 2026-08-25：Box iOS 和 OS X SDK API。
...
* [Open Source apps](https://github.com/dkhamsing/open-source-ios-apps) ⭐ 51,843 | 🐛 4 | 📅 2026-08-25 开源 iOS app 列表。
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,624 | 🐛 61 | 🌐 Ruby | 📅 2024-06-02 列表。
...
* 优秀的 Swift 列表
  * [@matteocrippa](https://github.com/matteocrippa/awesome-swift) ⭐ 26,222 | 🐛 11 | 🌐 Ruby | 📅 2026-08-03：一个优秀的 Swift 资源合集列表。
