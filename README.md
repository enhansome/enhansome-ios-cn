...
我想很多程序员应该记得 GitHub 上有一个 Awesome - XXX 系列的资源整理。[awesome-ios](https://github.com/vsouza/awesome-ios) ⭐ 53,451 | 🐛 27 | 🌐 Swift | 📅 2026-08-27 就是 vsouza 发起维护的 iOS 资源列表，内容包括：框架、组件、测试、Apple Store、SDK、XCode、网站、书籍等。Swift 语言写成的项目会被标记为 ★ ，AppleWatch 的项目则会被标记为 ▲。
...
* [Spring](http://hao.importnew.com/spring_ios/)：一个简单的 Swift iOS 动画库。[官网](https://github.com/MengTo/Spring) ⭐ 14,064 | 🐛 164 | 🌐 Swift | 📅 2023-07-03
...
* [ios-charts](http://hao.importnew.com/ios-charts/)：一个强大的图表框架，[MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,170 | 🐛 2,066 | 🌐 Java | 📅 2026-09-22 在 iOS 上的移植。★[官网](https://github.com/danielgindi/ios-charts) ⭐ 28,007 | 🐛 977 | 🌐 Swift | 📅 2026-03-07
* [PNChart](http://hao.importnew.com/pnchart/)：一个简单漂亮的图表库，Pinner 和 CoinsMan 的iOS客户端中使用了这个框架。[官网](https://github.com/kevinzhow/PNChart) ⭐ 9,636 | 🐛 173 | 🌐 Objective-C | 📅 2018-07-02
...
* Mantle：面向 Cocoa 和 Cocoa Touch 的模型框架 Model 。[官网](https://github.com/Mantle/Mantle) ⭐ 11,245 | 🐛 0 | 🌐 Objective-C | 📅 2022-10-18
...
* Nuke：高级的图片管理框架。★[官网](https://github.com/kean/Nuke) ⭐ 8,672 | 🐛 16 | 🌐 Swift | 📅 2026-09-24
...
* APNS-Pusher：苹果推送通知服务的调试器。[官网](https://github.com/KnuffApp/Knuff) ⭐ 5,216 | 🐛 19 | 🌐 Objective-C | 📅 2022-09-04
...
* Twitter Text Obj：Twitter 的文本处理库的 Objective-C 实现。[官网](https://github.com/twitter/twitter-text) ⭐ 3,135 | 🐛 94 | 🌐 HTML | 📅 2024-04-26
...
* IQKeyboardManager：防止键盘滑出来遮挡住 UITextField/UITextView 的框架，非侵入，无需代码。[官网](https://github.com/hackiftekhar/IQKeyboardManager) ⭐ 16,630 | 🐛 8 | 🌐 Swift | 📅 2026-05-25
...
* JTAppleCalendar: 最好的iOS版雨燕日历库 ★[官网](https://github.com/patchthecode/JTAppleCalendar) ⭐ 7,651 | 🐛 83 | 🌐 Swift | 📅 2024-07-23
...
* GuillotineMenu：铡刀样式过渡动画的下拉菜单。★[官网](https://github.com/Yalantis/GuillotineMenu/tree/swift_2.0) ⭐ 2,877 | 🐛 0 | 🌐 Swift | 📅 2020-04-13
...
* SDevIconFonts：用于 Swift 的 Fontawesome, Iconic, Ionicons, Octicon。★[官网](https://github.com/0x73/SDevIconFonts) ⭐ 1,167 | 🐛 1 | 🌐 Swift | 📅 2022-08-05
...
* SwiftLint：一个实验性的工具，用于强化 Swift 的代码风格和习惯。★[官网](https://github.com/realm/SwiftLint) ⭐ 19,745 | 🐛 508 | 🌐 Swift | 📅 2026-09-20
* Flex：一个嵌入 iOS App 的调试和探索工具。[官网](https://github.com/Flipboard/FLEX) ⭐ 14,642 | 🐛 50 | 🌐 Objective-C | 📅 2026-06-11
...
* [Darling](http://hao.importnew.com/darling/)：在 Linux 运行 OS X 二进制文件。[官网](http://www.darlinghq.org)、[GitHub](https://github.com/LubosD/darling) ⭐ 13,390 | 🐛 404 | 🌐 Objective-C | 📅 2026-09-06
...
* DoraemonKit: 一款功能齐全的iOS研发助手，你值得拥有。[官网](https://www.dokit.cn/) [Github](https://github.com/didi/DoraemonKit) ⭐ 20,420 | 🐛 276 | 🌐 Java | 📅 2026-09-22
...
* [fastlane](https://github.com/fastlane/fastlane) ⭐ 42,154 | 🐛 667 | 🌐 Ruby | 📅 2026-09-23 将所有 iOS 部署工具整合到一个工作流中。
...
* [Facebook](https://github.com/facebook/facebook-ios-sdk) ⭐ 8,109 | 🐛 153 | 🌐 Swift | 📅 2026-09-24：Facebook iOS SDK。
...
* [Stripe](https://github.com/stripe/stripe-ios) ⭐ 2,568 | 🐛 323 | 🌐 Swift | 📅 2026-09-24：iOS and OS X Stripe 绑定框架。
...
* Synx：一个重新组织你的 Xcode 项目的命令行工具，它能够让你的 group 和文件夹对应起来。[官网](https://github.com/venmo/synx) ⭐ 6,035 | 🐛 56 | 🌐 Ruby | 📅 2019-07-18
...
* [Open Source apps](https://github.com/dkhamsing/open-source-ios-apps) ⭐ 52,268 | 🐛 8 | 📅 2026-09-24 开源 iOS app 列表。
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,687 | 🐛 66 | 🌐 Ruby | 📅 2024-06-02 列表。
...
* 优秀的 Swift 列表
  * [@matteocrippa](https://github.com/matteocrippa/awesome-swift) ⭐ 26,275 | 🐛 15 | 🌐 Ruby | 📅 2026-09-01：一个优秀的 Swift 资源合集列表。
