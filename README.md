...
我想很多程序员应该记得 GitHub 上有一个 Awesome - XXX 系列的资源整理。[awesome-ios](https://github.com/vsouza/awesome-ios) ⭐ 53,349 | 🐛 27 | 🌐 Swift | 📅 2026-08-27 就是 vsouza 发起维护的 iOS 资源列表，内容包括：框架、组件、测试、Apple Store、SDK、XCode、网站、书籍等。Swift 语言写成的项目会被标记为 ★ ，AppleWatch 的项目则会被标记为 ▲。
...
* [ios-charts](http://hao.importnew.com/ios-charts/)：一个强大的图表框架，[MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,177 | 🐛 2,191 | 🌐 Java | 📅 2025-06-05 在 iOS 上的移植。★[官网](https://github.com/danielgindi/ios-charts) ⭐ 28,007 | 🐛 977 | 🌐 Swift | 📅 2026-03-07
...
* Mantle：面向 Cocoa 和 Cocoa Touch 的模型框架 Model 。[官网](https://github.com/Mantle/Mantle) ⭐ 11,249 | 🐛 0 | 🌐 Objective-C | 📅 2022-10-18
...
* CocoaLumberjack：一个快捷强大灵活的日志框架，可用于 iOS & Mac。[官网](https://github.com/CocoaLumberjack/CocoaLumberjack) ⭐ 13,320 | 🐛 7 | 🌐 Objective-C | 📅 2026-08-12
...
* ASIHTTPRequest：Objective-C 编写的 HTTP 网络请求库。它是对 CFNetwork 易用的封装。支持 Mac OS X 和 iPhone。[官网](https://github.com/pokeb/asi-http-request) ⭐ 5,722 | 🐛 167 | 🌐 Objective-C | 📅 2019-01-15
...
* YYText：iOS 上用于显示和编辑富文本的强大文本框架。[官网](https://github.com/ibireme/YYText) ⭐ 8,865 | 🐛 516 | 🌐 Objective-C | 📅 2024-07-16
...
* JTAppleCalendar: 最好的iOS版雨燕日历库 ★[官网](https://github.com/patchthecode/JTAppleCalendar) ⭐ 7,650 | 🐛 83 | 🌐 Swift | 📅 2024-07-23
...
* SVWebViewController：一个非侵入式的内置浏览器。[官网](https://github.com/TransitApp/SVWebViewController) ⭐ 2,552 | 🐛 74 | 🌐 Objective-C | 📅 2020-04-30
...
* SwiftLint：一个实验性的工具，用于强化 Swift 的代码风格和习惯。★[官网](https://github.com/realm/SwiftLint) ⭐ 19,727 | 🐛 502 | 🌐 Swift | 📅 2026-09-03
...
* Specta：轻量级 TDD / BDD Objective-C & Cocoa 开发框架。[官网](https://github.com/specta/specta) ⭐ 2,310 | 🐛 18 | 🌐 Objective-C | 📅 2022-02-27
...
* R.swift：在 Swift 项目中，强类型的自动补全资源名称的工具，包括图片，单元格和 segue 的工具。★[官网](https://github.com/mac-cain13/R.swift) ⭐ 9,560 | 🐛 78 | 🌐 Swift | 📅 2025-04-01
...
* [fastlane](https://github.com/fastlane/fastlane) ⭐ 42,110 | 🐛 669 | 🌐 Ruby | 📅 2026-09-14 将所有 iOS 部署工具整合到一个工作流中。
...
* [Facebook](https://github.com/facebook/facebook-ios-sdk) ⭐ 8,107 | 🐛 152 | 🌐 Swift | 📅 2026-09-14：Facebook iOS SDK。
...
* [Stripe](https://github.com/stripe/stripe-ios) ⭐ 2,570 | 🐛 291 | 🌐 Swift | 📅 2026-09-14：iOS and OS X Stripe 绑定框架。
...
* [Box](https://github.com/box/box-ios-sdk) ⭐ 130 | 🐛 7 | 🌐 Swift | 📅 2026-09-09：Box iOS 和 OS X SDK API。
...
* FuzzyAutocompletePlugin：提供了除前缀匹配之外的其他更加灵活的自动补全功能，支持 Xcode 5+。[官网](https://github.com/FuzzyAutocomplete/FuzzyAutocompletePlugin) ⭐ 3,221 | 🐛 18 | 🌐 Objective-C | 📅 2017-06-16
...
* [Open Source apps](https://github.com/dkhamsing/open-source-ios-apps) ⭐ 52,122 | 🐛 1 | 📅 2026-09-14 开源 iOS app 列表。
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,671 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02 列表。
* [awesome-ios-ui](https://github.com/cjwirth/awesome-ios-ui) ⭐ 11,212 | 🐛 12 | 📅 2018-03-08：优秀的 iOS UI/UX 库列表。
* [awesome-ios-animation](https://github.com/sxyx2008/awesome-ios-animation) ⭐ 5,461 | 🐛 0 | 📅 2025-10-28：包括了 Objective-C 和 Swift 实现的 iOS 动画库列表。
...
* 优秀的 Swift 列表
  * [@matteocrippa](https://github.com/matteocrippa/awesome-swift) ⭐ 26,256 | 🐛 13 | 🌐 Ruby | 📅 2026-09-01：一个优秀的 Swift 资源合集列表。
